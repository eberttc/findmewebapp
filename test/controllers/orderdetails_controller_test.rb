...
class OrderdetailsControllerTest < ActionController::TestCase
  ...
  test "should create orderdetail" do
    assert_difference('Orderdetail.count') do
      post :create, orderdetail: { order_id: @orderdetail.order_id, price: @orderdetail.price, quantity: @orderdetail.quantity, subtotal: @orderdetail.subtotal }
    end
  ...
  test "should update orderdetail" do
    patch :update, id: @orderdetail, orderdetail: { order_id: @orderdetail.order_id, price: @orderdetail.price, quantity: @orderdetail.quantity, subtotal: @orderdetail.subtotal }
    assert_redirected_to orderdetail_path(assigns(:orderdetail))
  end
